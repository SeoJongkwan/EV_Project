...
dsr_ack_parsing['RegDt'] = dsr_ack_mt['RegDt'].copy()
...
cols = ['RegDt', 'ServerId', 'ChargerId', 'Length', 'MessageType', 'SequenceNumber','DataLength', 'MessagePending_type',
        'MessagePending', 'WakeupInterval_type', 'WakeupInterval', 'ChargerNumber_type','ChargerNumber', 'Send', 'msgId']
dsr_ack_parsing = dsr_ack_parsing[cols]
